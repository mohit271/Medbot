...
public class MessageRVAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case 0:
                ...
                view = LayoutInflater.from(parent.getContext()).inflate(R.layout.outgoing_sample, parent, false);
                return new UserViewHolder(view);
            case 1:
                // below line we are inflating bot message layout.
                view = LayoutInflater.from(parent.getContext()).inflate(R.layout.incoming_sample, parent, false);
    ...
    public static class UserViewHolder extends RecyclerView.ViewHolder {
        ...
        public UserViewHolder(@NonNull View itemView) {
            ...
            userTV = itemView.findViewById(R.id.tvSenderMessage);
        }
    }
    ...
    public static class BotViewHolder extends RecyclerView.ViewHolder {
        ...
        public BotViewHolder(@NonNull View itemView) {
            super(itemView);
            // initializing with id.
            botTV = itemView.findViewById(R.id.tvReceiverMessage);
        }
    }
}
